...
namespace EasyMigLib.Information.SqlClient
{
    public class SqlInformation
    {
        ...
        protected ISqlDatabaseInformationQueryService queryService;

        public string ProviderName { get; }

        public SqlInformation()
            :this(new DbService(), new SqlDatabaseInformationQueryService())
        { }

        public SqlInformation(IDbService dbService, ISqlDatabaseInformationQueryService queryService)
        {
