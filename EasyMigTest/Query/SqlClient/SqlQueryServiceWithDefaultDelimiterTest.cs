...
namespace EasyMigTest.Query.SqlClient
{
    [TestClass]
    public class SqlQueryServiceWithDefaultDelimiterTest
    {
        ...
        public void TestFormatTableName()
        {
            ...
            var result = service.FormatWithSchemaName("table1");
        ...
        public void TestDropStoredProcedure()
        {
            ...
            Assert.AreEqual("DROP PROCEDURE IF EXISTS [dbo].[p1];\r", result);
        }
