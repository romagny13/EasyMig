...
namespace EasyMigLib.Information.SqlClientAttachedDbFile
{
    public class SqlFileInformation
    {
        ...
        protected ISqlFileDatabaseInformationQueryService queryService;

        public string ProviderName { get; }

        public SqlFileInformation()
            :this(new DbService(), new SqlFileDatabaseInformationQueryService())
        { }

        public SqlFileInformation(IDbService dbService, ISqlFileDatabaseInformationQueryService queryService)
        {
