...
{
    public class SqlServerAttachedDbFile
    {
        protected SqlFileSchema container;

        protected CommandContainer commandContainer;

        public SqlServerAttachedDbFile(CommandContainer commandContainer)
        {
            this.container = new SqlFileSchema(commandContainer);
        }
