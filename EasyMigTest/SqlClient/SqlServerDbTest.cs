...
namespace EasyMigTest.SqlClient
{
    ...
    public class SqlServerDbTest
    {
        ...
        public void TestGetStoredProcedureQuery()
        {
            ...
            var container = new SqlSchema(commands);
        ...
        public void TestGetSeedOnlyFor_SeederAndDbServiceCalled()
        {
            ...
            var container = new SqlSchema(new MigrationAssemblyService(), new SqlQueryService(), service, new CommandContainer());

            var recognizedFile = new RecognizedMigrationFile(typeof(SeederA), "SeederA", "SeederA");

            container.DoSeedOnlyFor(recognizedFile, "");
        ...
        public void TestSeederIsClear()
        {
            ...
            var container = new SqlSchema(new MigrationAssemblyService(), new SqlQueryService(), service, commands);
