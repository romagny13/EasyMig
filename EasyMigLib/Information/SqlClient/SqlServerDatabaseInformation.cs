...
{
    public class SqlServerDatabaseInformation
    {
        protected IDbService dbService;
        protected ISqlServerDatabaseInformationQueryService queryService;

        public string ProviderName { get; }

        public SqlServerDatabaseInformation()
            :this(new DbService(), new SqlServerDatabaseInformationQueryService())
        { }

        public SqlServerDatabaseInformation(IDbService dbService, ISqlServerDatabaseInformationQueryService queryService)
        {
