...
namespace EasyMigTest.MySqlClient
{
    ...
    public class MySqlSchemaTest
    {
        ...
        public void TestGetStoredProcedureQuery()
        {
            ...
            commands.CreateStoredProcedure("proc1")
                ...
                .SetBody("select * from users where id=p_id");
            ...
            Assert.AreEqual("DELIMITER $$\rDROP PROCEDURE IF EXISTS `proc1`$$\rCREATE PROCEDURE `proc1`(p_id INT)\rBEGIN\rselect * from users where id=p_id;\rEND$$\rDROP PROCEDURE IF EXISTS `proc2`$$\rCREATE PROCEDURE `proc2`()\rBEGIN\rselect * from users;\rEND$$\rDELIMITER ;", query);
        }
        ...
        public void TestGetSeedQuery()
        {
            ...
            Assert.AreEqual("INSERT INTO `table1` (`id`,`column1`) VALUES (1,'value 1');\rINSERT INTO `table1` (`id`,`column1`) VALUES (2,'value 2');\r\rINSERT INTO `table2` (`id`,`columna`) VALUES (1,'value a');\r", query);
        }
        ...
        {
            var service = new MySqlFakeDbService();
            ...
            var container = new MySqlSchema(new MigrationAssemblyService(), new MySqlQueryService(), service, new CommandContainer());
        ...
        public void TestSeederIsClear()
        {
            ...
            var container = new MySqlSchema(new MigrationAssemblyService(), new MySqlQueryService(), service, commands);
         
            var recognizedFile = new RecognizedMigrationFile(typeof(SeederA), "SeederA", "SeederA");
            container.DoSeedOne(recognizedFile, "");

            Assert.AreEqual("INSERT INTO `table1` (`id`,`column1`) VALUES (1,'value 1');\rINSERT INTO `table1` (`id`,`column1`) VALUES (2,'value 2');\r\rINSERT INTO `table2` (`id`,`columna`) VALUES (1,'value a');\r", service.Query);
   ...
   .Insert(SeedData.New.Set("id", 1).Set("columna", "value a"));
        ...
        public void TestUpdateOnlyFor_WithDown()
        {
            ...
            container.RunMigrationAndUpdateDatabase(recognizedFile, "", null, MigrationDirection.Down);
        ...
        public void TestUpdateAll_WithDown()
        {
            ...
            container.DoMigrations(files, "", null, MigrationDirection.Down);
