...
namespace EasyMigLib.SqlClient
{
    public class SqlSchema
    {
        ...
        public SqlSchema(CommandContainer container)
        ...
        public virtual string GetMigrationQuery()
        {
            var result = new List<string>();
        ...
        public void DoSeedOnlyFor(RecognizedMigrationFile recognizedType, string connectionString)
        {
            try
            {
                this.dbService.CreateConnection(connectionString, this.ProviderName);
        ...
        public void DoSeedOnlyFor(string seederFileName, Type[] assemblyTypes, string connectionString)
        {
            ...
            {
                this.DoSeedOnlyFor(recognizedType, connectionString);
            }
        }
